...
namespace PartsPageClasses
{
    public class Brakes : IBrakes
    {
        ...
        public Brakes()
        {
            ...
            _driver = DriverFactory.GetDriver("http://localhost:5000/Store/Browse?CategoryId=1");
